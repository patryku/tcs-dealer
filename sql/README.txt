...
8. Konfiguracje - służy do zapisywania konkretnych konfiguracji danego egzemplarza. Analogicznie jak w tabeli wyposażenia, dla każdego pojazdu identyfikowanego przez vin, zapisujemy elementy wyposażenia, które są w nim zainstalowane (jedna krotka - jeden element).
